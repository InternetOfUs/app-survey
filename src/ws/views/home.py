...
logger = logging.getLogger("wenet-survey-web-app.ws.views.home")
    ...
    def get(self, request: Request):
        if request.session.get('has_logged', False):
            ...
            try:
                ...
                return render(request, 'ws/home_logged.html', context=context)
            ...
            context = {'login_url': f'{os.getenv("INSTANCE")}/hub/frontend/oauth/login?client_id={os.getenv("APP_ID")}'}
            return render(request, 'ws/home_not_logged.html', context=context)
